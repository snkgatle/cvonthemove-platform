                ...
                <div key={field.id} className="array-item-card">
                    ...
                    <div className="grid-2">
                        <div className="form-group">
                            ...
                            <input {...register(`educations.${index}.institution`)} placeholder="University / School" />
                            {errors.educations?.[index]?.institution && <span className="error">{errors.educations[index]?.institution?.message}</span>}
                        </div>
                        <div className="form-group">
                            <label>Degree</label>
                            <input {...register(`educations.${index}.degree`)} placeholder="Bachelor's, Master's, etc." />
                            {errors.educations?.[index]?.degree && <span className="error">{errors.educations[index]?.degree?.message}</span>}
                        </div>
                        <div className="form-group">
                            <label>Field of Study</label>
                            <input {...register(`educations.${index}.fieldOfStudy`)} placeholder="Computer Science, etc." />
