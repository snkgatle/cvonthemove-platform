            ...
            {fields.map((field, index) => (
                <div key={field.id} className="array-item-card">
                    ...
                    <div className="form-group">
                        ...
                        <textarea {...register(`workExperiences.${index}.description`)} rows={4} placeholder="Describe your responsibilities and achievements..." />
